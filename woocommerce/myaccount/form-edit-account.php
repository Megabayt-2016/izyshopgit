...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="woocommerce-form-row woocommerce-form-row--first form-row form-row-first group-form">
	...
	<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide group-form">
	...
	<fieldset>
		...
		<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide group-form">
			<label for="password_current" class="mr-5"><?php esc_html_e( 'Current password (leave blank to leave unchanged)', 'woocommerce' ); ?></label>
		...
		<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide group-form">
			<label for="password_1" class="mr-5"><?php esc_html_e( 'New password (leave blank to leave unchanged)', 'woocommerce' ); ?></label>
		...
		<div class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide group-form">
			<label for="password_2" class="mr-5"><?php esc_html_e( 'Confirm new password', 'woocommerce' ); ?></label>
